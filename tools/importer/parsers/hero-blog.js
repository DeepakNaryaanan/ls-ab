 ...
 * Base block: hero
 * Source URL: https://www.ensure.com/blog/nutrition-matters/five-secret-superfoods
 * Selector: .m-hero
 * Generated: 2026-05-24T00:00:00Z
 *
 * Extracts category hero banner with heading and image from blog pages.
 * Structure: H1 heading (blog category name like "Expert Advice") + large banner image.
...
export default function parse(element, { document }) {
  ...
  // Row 1: Hero image (blog category banner)
  if (image) {
    cells.push([image]);
  }

  // Row 2: Heading text (blog category name)
  if (heading) {
    cells.push([heading]);
  }
