...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-health-article.js
  var import_health_article_exports = {};
  __export(import_health_article_exports, {
    default: () => import_health_article_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "health-article",
    description: "Health tips and articles covering nutrition, fitness, and lifestyle topics",
    blocks: [
    ...
    sections: [
      { id: "section-1-hero", name: "Article Hero", selector: ".m-hero", style: null, blocks: ["hero-blog"], defaultContent: [] },
  ...
  var import_health_article_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_health_article_exports);
})();
